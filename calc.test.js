...
describe('calculator functionality', () => {
  ...
  test('check input one is  not null', () => {
    expect(container.querySelector('#input1')).not.toBeNull();
  })

  test('check input two is not null', () => {
    expect(container.querySelector('#input2')).not.toBeNull();
  })
